  ...
  return (
    ...
    >
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <FieldGroup label="Full name" name="name" value={form.name} onChange={handleChange} placeholder="Aman Kumar" />
        <FieldGroup label="Email address" name="email" type="email" value={form.email} onChange={handleChange} placeholder="aman@example.com" />
        <FieldGroup label="Password" name="password" type="password" value={form.password} onChange={handleChange} placeholder="Create a strong password" />
